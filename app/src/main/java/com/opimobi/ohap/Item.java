...
public abstract class Item {
     ...
     * @exception java.lang.IllegalArgumentException If the parent argument is null, if the id is not positive integer or if an item with the same id exists within the same central unit.
     */
    ...
    /**
     * Asks the item to remove itself from the parent container. The item is kept valid
     * otherwise.
     */
